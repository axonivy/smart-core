...
import static ch.ivyteam.ivy.scripting.dataclass.resource.DataClassFileExtensions.DATA_CLASS_EXTENSION;
...
public class FormSchemaTool implements SchemaTool {
  ...
  private static final String GUIDELINES = """
    ...
    - The form must be located in a subdirectory of '<project-root>/""" + ProjectDir.SRC_HD + """
    /' but not directly in it. At least one other directory between '""" + ProjectDir.SRC_HD + """
