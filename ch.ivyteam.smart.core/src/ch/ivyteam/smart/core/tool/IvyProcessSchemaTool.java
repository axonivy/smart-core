...
public interface IvyProcessSchemaTool {
  ...
  String DESCRIPTION = """
    Returns the JSON schema and guidelines for handling Axon Ivy process definitions.
  ...
  String GUIDELINES = """
    Guidelines:
    - Process files must be located in a subdirectory of '<project-root>/processes/'.
